        ...
        <div v-for="(item, index) in list" class="lists" :key="index" @click="engindetails(item.id)" >
          <div>
            ...
            <div>
              ...
              <div><span>付款金额:</span><span>{{item.money}}</span></div>
            </div>
            <div>
              <div><span>付款日期:</span><span>{{item.paydt}}</span></div>
              <div><span>付款方式:</span><span>{{item.paytype}}</span></div>
            </div>
            <div>
              <div><span>收款单位:</span><span>{{item.receivablesunit}}</span></div>
              <div><span>收款账号:</span><span>{{item.receivablesnum}}</span></div>
            </div>
            <div>
              <div></div>
              <div >
